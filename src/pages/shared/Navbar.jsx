...
//                     {/* menu btn, visible on small screen */}
//                     <div className="md:hidden">
...
//                         <FaBlog className="inline-block text-black-700" />
//                         <span className="text-black text-3xl">Book</span>
//                         <span className="text-blue-700 text-2xl">Shop</span>
//                     </Link>

//                     <ul className="md:flex space-x-12 hidden navitems">
//                         {navItems.map(({ link, path }) => (
//                             <Link key={link} to={path} className="link block text-xl cursor-pointer uppercase  text-black hover:text-blue-700">
//                                 {link}
//                             </Link>
//                         ))}
//                     </ul>
...
//                             key={link}
//                             onClick={toggleMenu}
//                             className="block text-xl text-black hover:text-blue-700"
//                         >
//                             {link}
//                         </a>
//                     ))}
            ...
            <nav className={`py-4 lg:px-24 px-4 ${isSticky ? "bg-white" : "bg-white"}`}>
                <div className="flex justify-between items-center text-base gap-8">
                    <Link to="/" className="text-2xl font-bold flex items-center gap-2">
                        ...
                        <span className="text-blue-700">Shelf</span>
                    </Link>
