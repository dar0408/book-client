...
const SingleBook = () => {
    ...
    useEffect(() => {
        ...
        const fetchReviews = async () => {
            const response = await fetch(`https://d-server-silk.vercel.app//book/${_id}/reviews`);
    ...
    const handleReviewSubmit = async (e) => {
        ...
        if (isEditing) {
            ...
            const response = await fetch(`https://d-server-silk.vercel.app//book/${_id}/review`, {
                method: 'POST',
                headers: {
    ...
    const handleDelete = async (index) => {
        ...
        const response = await fetch(`https://d-server-silk.vercel.app//book/${_id}/review/${reviewId}`, {
            method: 'DELETE',
        });
