...
import googleLogo from '../assets/google-logo.svg';
import fbLogo from '../assets/facebook-log.svg';
import { auth, googleProvider, storage, db } from '../firebase/firebase.config';
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleSignup} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div className="relative">
                                    <input id="name" name="name" type="text" className="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Full Name" required />
                                </div>
                                <div className="relative">
                                ...
                                <div className="relative">
                                    <input id="photo" name="photo" type="file" className="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" accept="image/*" />
                                </div>
                    ...
                    <div>
                        ...
                        <div className="flex w-full items-center flex-col mt-5 gap-3">
                            <button onClick={handleRegister} className='block'>
                                <img src={googleLogo} alt="Google Logo" className='w-12 h-12 inline-block' />Log in with Google
                            </button>
                            <button>
                                <img src={fbLogo} alt="Facebook Logo" className='w-10 h-10 inline-block mr-1' />Log in with Facebook
                            </button>
                        </div>
                    </div>
                </div>
